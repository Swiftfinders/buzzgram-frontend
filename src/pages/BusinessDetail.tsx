        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-6">
            ...
            {business.instagramHandle && (
              <a
                ...
                className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-2 px-6 py-3 border-2 border-gray-300 dark:border-dark-border text-gray-700 dark:text-gray-300 rounded-lg font-medium hover:border-orange-500 dark:hover:border-orange-500 hover:text-orange-600 dark:hover:text-orange-400 transition-all min-h-[44px]"
              >
            ...
            <button
              ...
              className="flex-1 sm:flex-initial inline-flex items-center justify-center px-6 py-3 bg-orange-500 text-white rounded-lg font-medium hover:bg-orange-600 transition-colors shadow-sm min-h-[44px]"
            >
              Claim This Business
            </button>
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-3">
              ...
              {/* Category Badge */}
              {business.category && (
                <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-orange-50 dark:bg-orange-900/20 text-orange-700 dark:text-orange-400 rounded-full text-sm font-medium">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          ...
          <div className="max-w-4xl space-y-8">
            ...
            {business.category && (
              <div>
                ...
                <div className="inline-flex items-center gap-2 text-gray-700 dark:text-gray-300 text-base">
                  <span className="text-xl">{business.category.icon}</span>
                  <span>{business.category.name}</span>
                  {business.subcategory && (
                    <>
                      <span className="text-gray-400 dark:text-gray-500">•</span>
                      <span className="text-lg">{business.subcategory.icon}</span>
            ...
            {business.subcategory ? (
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
                  ...
                  <span className="text-base">{business.subcategory.name}</span>
                </div>
                <div className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
                  <svg className="w-5 h-5 text-orange-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-base">{business.category?.name}</span>
                </div>
              </div>
            ) : (
        ...
        {activeTab === 'reviews' && (
          <div className="max-w-4xl">
            ...
            <div className="text-center py-12 bg-gray-50 dark:bg-dark-card rounded-lg border border-gray-200 dark:border-dark-border">
        ...
        {activeTab === 'quote' && (
          <div className="max-w-4xl">
            ...
            <div className="bg-gray-50 dark:bg-dark-card rounded-lg border border-gray-200 dark:border-dark-border p-8">
              ...
              <div className="space-y-4">
                ...
                {business.phone && (
                  <div className="pt-4">
                    <p className="text-gray-600 dark:text-gray-400 text-sm mb-2">Or call directly:</p>
                    <a
                      href={`tel:${business.phone}`}
                      className="text-orange-600 dark:text-orange-400 hover:text-orange-700 dark:hover:text-orange-300 font-medium text-lg"
                    >
                      {business.phone}
                    </a>
                  </div>
